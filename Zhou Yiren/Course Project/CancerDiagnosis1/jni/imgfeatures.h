...
struct feature
{
  ...
  int d;                         /**< descriptor length 128*/
  double descr[FEATURE_MAX_D];   /**< descriptor *///duoc dinh nghia co dinh, ko cap phat vung nho
  double *mydescr;//[MY_FEATURE_MAX_D];
